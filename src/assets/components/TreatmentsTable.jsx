    ...
    return (
        <>
            <div className="mb-3 d-flex align-items-end justify-content-end w-100">
                 <p class="me-2 fw-bold bg-danger bg-opacity-50 rounded-3 p-2 border border-dark">Commission: ₱ {overallCommission.toFixed(2)}</p>
                 <p class=" fw-bold bg-success bg-opacity-50 rounded-3 border border-dark p-2">Tip: ₱ {overallTip.toFixed(2)}</p>
            </div>
